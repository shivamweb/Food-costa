...
<div class="container-fluid">
    <div class="form-head dashboard-head d-md-flex d-block mb-5 align-items-start">
        <h2 class="dashboard-title me-auto">FOOD PRODUCTS <a href="javascript:void(0);" class="btn btn-success btn-rounded ms-4 text-white d-inline-block flex-grow-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Add New
            </a></h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="action-buttons d-flex justify-content-end">
									<a href="javascript:void(0);" class="btn btn-primary light me-2"data-bs-toggle="modal" data-bs-target="#exampleModal">
    ...
    <div class="modal-dialog modal-dialog-center">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" method="POST" action="{{route('addproduct')}}">
                    @csrf
                    <div class="form">
                        <div class="form-group">
                            <label for="class" class="mb-1">Product Name :</label>
                    ...
                    <div class="form">
                        <div class="form-group">
                            <label for="class" class="mb-1">Quantity :</label>
