...
<div class="container-fluid">
    <div class="form-head dashboard-head d-md-flex d-block mb-5 align-items-start">
        <h2 class="dashboard-title me-auto">FOOD CATEGORY <a href="javascript:void(0);" class="btn btn-success btn-rounded ms-4 text-white d-inline-block flex-grow-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Add New
            </a></h2>
                ...
                <form class="needs-validation" method="POST" action="{{route('addcategory')}}">
                    ...
                    <div class="form">
                        <div class="form-group">
                            <label for="class" class="mb-1">Category Name :</label>
